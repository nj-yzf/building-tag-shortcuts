...
The current installed build uses `1..9` for levels and `Ctrl+Shift+D` for toggling. Older experimental shortcuts `Ctrl+Alt+L` and `Ctrl+Alt+B` are no longer used.
