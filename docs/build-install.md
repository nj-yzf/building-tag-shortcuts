...
Then assign `Ctrl+Shift+D` manually if needed. The direct `1..9` level shortcuts are handled by the plugin's key dispatcher, so they may not behave like ordinary JOSM shortcut-preference entries.
